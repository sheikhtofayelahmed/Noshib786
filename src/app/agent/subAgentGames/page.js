...
const SubAgentSummary = () => {
 ...
 .first-container {
  ...
  if (Object.keys(groupedBySAId).length === 0) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-gray-900 to-yellow-400text-white font-mono">
  ...
  return (
    <div className="min-h-screen p-6 bg-gradient-to-br from-black via-gray-900 to-yellow-400text-white font-mono">
