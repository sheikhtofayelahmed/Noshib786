  ...
  if (fetched && players.length === 0)
    return (
      <div className="fixed inset-0 z-50 bg-black bg-opacity-70 flex justify-center items-center">
        <div className="relative max-w-fit bg-gradient-to-br from-black via-gray-900 to-yellow-400text-white font-mono rounded-xl  w-full max-h-[90vh] overflow-y-auto p-6">
