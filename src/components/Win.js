...
export default function Win() {
  ...
  return (
    <div className="my-3 bg-gray-900 bg-opacity-80 rounded-sm shadow-md ring-2 ring-yellow-500 p-3 text-center">
      <h2 className="text-xl font-bold text-yellow-400 mb-2 animate-pulse">
